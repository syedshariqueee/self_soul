    ...
    <header className="relative z-50 border-b border-[#eadfcd] bg-[#f7efe3] px-4 py-3 sm:px-6 md:px-8">
      <div className="flex items-center justify-between gap-4">
        <Link to="/" className="shrink-0">
          <p className="text-2xl font-medium leading-none tracking-[0.15em] text-[#1c2d3a] sm:text-4xl sm:tracking-[0.18em]">
            SELF SOUL
          </p>
          <p className="mt-1 text-[8px] uppercase tracking-[0.36em] text-[#8b857a] sm:text-[10px] sm:tracking-[0.45em]">
            Herbal Skin Naturals
          </p>
        </Link>
        ...
        <nav className="hidden items-center rounded-full border border-[#ebdfd1] bg-[#f8f1e7] px-3 py-2 font-['Montserrat',sans-serif] shadow-[inset_0_1px_0_rgba(255,255,255,0.7),0_3px_10px_rgba(58,44,28,0.08)] lg:flex">
          {[
            ...
            <div key={item} className="group/navitem h-full">
              <Link
                to={item === "Home" ? "/" : item === "Our Heritage" ? "/our-heritage" : "#"}
        ...
        <div className="flex items-center gap-3 text-[#263630]">
          <span className="text-sm cursor-pointer">⌕</span>
          <span className="text-sm cursor-pointer">♡</span>
          <span className="text-sm cursor-pointer">👜</span>
          <Link to="/login" className="hidden text-sm sm:inline cursor-pointer">◌</Link>
        </div>
      </div>
