      ...
      <div className="mx-auto w-full max-w-[1366px] bg-white">
        ...
        >
          <div className="max-w-[560px]">
            <p className="mb-2 text-3xl italic leading-none text-[#162f43] sm:mb-3 sm:text-4xl md:text-[42px]">
              Get more, spend less!
            </p>
        ...
        <section className="bg-white px-4 py-8 sm:px-6 sm:py-10 md:px-10 md:py-12 lg:px-14">
          <div className="w-full border border-[#e8e6e2] bg-white py-6 sm:py-7 md:py-8">
            <div className="grid w-full grid-cols-1 gap-4 md:grid-cols-[minmax(0,2fr)_minmax(0,3fr)] md:items-stretch md:gap-[10px]">
              <div className="flex min-h-0 w-full flex-col items-start justify-center bg-[#414d47] px-8 py-10 font-['Montserrat',sans-serif] text-white sm:px-10 sm:py-12 md:h-full md:min-h-0 md:px-9 md:py-10 lg:px-10 lg:py-11">
                ...
                <div className="min-h-0 w-full md:h-full md:min-h-0">
                  <div className="grid h-auto min-h-[200px] w-full grid-cols-2 grid-rows-3 gap-[10px] bg-white md:h-full md:min-h-0 md:[grid-template-columns:repeat(3,minmax(0,1fr))] md:[grid-template-rows:repeat(2,minmax(0,1fr))]">
                    {bestsellerImages.map((item) => (
                      <div
                        key={item.src}
                        className="relative aspect-square min-h-0 min-w-0 overflow-hidden bg-neutral-100 md:aspect-auto md:h-full"
                      >
                        <img
                          src={item.src}
                          alt={item.alt}
        ...
        <section className="px-4 sm:px-6 md:px-10 lg:px-14">
          <div className="mx-auto flex max-w-[1440px] min-h-[200px] items-center justify-center bg-[#e8e8e8] font-['Montserrat',sans-serif] text-lg font-medium text-[#1a3030] sm:min-h-[240px] sm:text-xl">
            Video
          </div>
        </section>
        ...
        <section className="border-y border-[#ece8e0] px-4 py-5 sm:px-6 md:px-8 lg:px-10">
          <h4 className="text-center text-sm uppercase tracking-[0.2em] text-[#4f6257]">
            Bio Fuel Healthcare
          </h4>
          <div className="mt-4 grid grid-cols-2 gap-2 text-center text-xs sm:gap-3 md:grid-cols-5">
            {ingredientTags.map((tag) => (
              <p key={tag} className="rounded border border-[#e7e1d7] px-2 py-3">
                {tag}
              </p>
            ))}
          </div>
